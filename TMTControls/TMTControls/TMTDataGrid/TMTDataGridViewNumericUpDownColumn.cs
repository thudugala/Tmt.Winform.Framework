...
namespace TMTControls.TMTDataGrid
{
    ...
    public class TMTDataGridViewNumericUpDownColumn : DataGridViewColumn, ITMTDataGridViewColumn
    {
        ...
        [
            Category("Appearance"),
            DefaultValue(TMTDataGridViewNumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultDecimalPlaces),
        ...
        {
            return !this.Increment.Equals(TMTDataGridViewNumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultIncrement);
        }
        ...
        {
            return !this.Maximum.Equals(TMTDataGridViewNumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultMaximum);
        }
        ...
        {
            return !this.Minimum.Equals(TMTDataGridViewNumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultMinimum);
        }
        ...
        [
            Category("Data"),
            DefaultValue(TMTDataGridViewNumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultThousandsSeparator),
        ...
        /// </summary>
        private TMTDataGridViewNumericUpDownCell NumericUpDownCellTemplate
        {
            get
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("TMTDataGridViewNumericUpDownColumn { Name=");
            sb.Append(this.Name);
            sb.Append(", Index=");
