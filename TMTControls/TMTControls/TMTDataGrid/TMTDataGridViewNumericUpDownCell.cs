...
namespace TMTControls.TMTDataGrid
{
    ...
    /// </summary>
    public class TMTDataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        private static Type defaultEditType = typeof(TMTDataGridViewNumericUpDownEditingControl);

        // Type of this cell's value. The formatted value type is string, the same as the base class DataGridViewTextBoxCell
        private static Type defaultValueType = typeof(System.Int64);
        ...
        /// </summary>
        public TMTDataGridViewNumericUpDownCell()
        {
        ...
        /// </summary>
        private TMTDataGridViewNumericUpDownEditingControl EditingNumericUpDown
        {
            get
            {
                return this.DataGridView.EditingControl as TMTDataGridViewNumericUpDownEditingControl;
            }
        }
        ...
        {
            TMTDataGridViewNumericUpDownCell dataGridViewCell = base.Clone() as TMTDataGridViewNumericUpDownCell;
        ...
        public override bool KeyEntersEditMode(KeyEventArgs e)
        {
            ...
            {
                negativeSignKey = (Keys)(NativeMethods.VkKeyScan(negativeSignStr[0]));
            }
        ...
        private bool OwnsEditingNumericUpDown(int rowIndex)
        {
            ...
            TMTDataGridViewNumericUpDownEditingControl numericUpDownEditingControl = this.DataGridView.EditingControl as TMTDataGridViewNumericUpDownEditingControl;
                                      ...
                                      DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            if (!cellEdited)
            {
                if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
                {
                    ...
                    paintingNumericUpDown.TextAlign = TMTDataGridViewNumericUpDownCell.TranslateAlignment(cellStyle.Alignment);
