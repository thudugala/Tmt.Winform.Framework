...
{
    internal class DbTextButtonBoxEditingControl : TextButtonBoxBase, IDataGridViewEditingControl
    {
        public DbTextButtonBoxEditingControl()
        {
            InitializeComponent();
        }
        ...
        public void ApplyCellStyleToEditingControl(DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            this.TextAlign = DbTextButtonBoxCell.TranslateAlignment(dataGridViewCellStyle.Alignment);
        }
