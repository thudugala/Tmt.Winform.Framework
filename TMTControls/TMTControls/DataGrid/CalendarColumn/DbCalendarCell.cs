...
{
    public class DbCalendarCell : DataGridViewTextBoxCell
    {
        public DbCalendarCell()
            : base()
        {
        ...
        public override Type EditType
        {
            get
            {
                ...
                return typeof(DbCalendarEditingControl);
            }
        }
        ...
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            DbCalendarEditingControl ctl = DataGridView.EditingControl as DbCalendarEditingControl;
