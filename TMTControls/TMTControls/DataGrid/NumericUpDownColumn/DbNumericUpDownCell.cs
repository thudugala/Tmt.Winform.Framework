...
namespace TMT.Controls.WinForms.DataGrid
{
    ...
    /// </summary>
    public class DbNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        private static Type defaultEditType = typeof(DbNumericUpDownEditingControl);
        ...
        /// </summary>
        private DbNumericUpDownEditingControl EditingNumericUpDown
        {
            get
            {
                return this.DataGridView.EditingControl as DbNumericUpDownEditingControl;
            }
        }
        ...
        {
            DbNumericUpDownCell dataGridViewCell = base.Clone() as DbNumericUpDownCell;
                                      ...
                                      DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            if (!cellEdited)
            {
                if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
                {
                    ...
                    paintingNumericUpDown.TextAlign = DbNumericUpDownCell.TranslateAlignment(cellStyle.Alignment);
        ...
        private bool OwnsEditingNumericUpDown(int rowIndex)
        {
            ...
            DbNumericUpDownEditingControl numericUpDownEditingControl = this.DataGridView.EditingControl as DbNumericUpDownEditingControl;
